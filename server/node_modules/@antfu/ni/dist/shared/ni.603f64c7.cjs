...
const require$$0__default$7 = /*#__PURE__*/_interopDefaultCompat(require$$0$7);
...
async function getConfig() {
  if (!config) {
    ...
    let packageManager = "";
    if (result)
      packageManager = JSON.parse(fs__default.readFileSync(result, "utf8")).packageManager ?? "";
    ...
    else if (!fs__default.existsSync(rcPath))
...
if (!processOk(process$1)) {
  ...
  var assert = require$$0__default$3;
...
const {PassThrough: PassThroughStream} = require$$0__default$4;
...
const {constants: BufferConstants} = require$$0__default$5;
const stream = require$$0__default$4;
const {promisify} = require$$2__default$1;
...
const { PassThrough } = require$$0__default$4;
...
const readline = require$$0__default$7;
const { action } = util;
