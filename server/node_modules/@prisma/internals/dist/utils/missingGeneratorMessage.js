...
${(0, import_colors.blue)("info")} You don't have any generators defined in your ${(0, import_colors.bold)(
  "schema.prisma"
)}, so nothing will be generated.
You can define them like this:

${(0, import_colors.bold)(
  (0, import_highlight.highlightDatamodel)(`generator client {
  provider = "prisma-client-js"
}`)
)}`;
const missingModelMessage = `
You don't have any ${(0, import_colors.bold)("models")} defined in your ${(0, import_colors.bold)(
  "schema.prisma"
)}, so nothing will be generated.
You can define a model like this:

${(0, import_colors.bold)(
  (0, import_highlight.highlightDatamodel)(`model User {
